...
$data_user = mysqli_query($host, "SELECT * FROM user WHERE NOT roles = 'Administrator'");
...
<section class="h-screen pt-24">
    <div class="max-w-[1248px] mx-auto p-4 shadow sm:rounded-lg">
        <h1 class="text-xl font-bold">Halo Administrator
            ...
            <tbody>
                ...
                foreach ($data_maskapai as $data):
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <img src="<?= $folder_name ?>/gambar/unggah/<?= $data['logo_maskapai'] ?>" alt="Logo Maskapai"
                                width="200">
                        </td>
                        <td class="px-6 py-4">
                            <?= $data['nama_maskapai'] ?>
