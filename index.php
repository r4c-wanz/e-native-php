...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="<?= dirname($_SERVER['PHP_SELF']) ?>" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <?php else: ?>
            <a href="<?= ($_SESSION['auth']['role'] === 'Penumpang') ? 'penumpang' : (($_SESSION['auth']['role'] === 'Petugas') ? 'petugas' : 'admin') ?>"
    ...
    <div id="default-carousel" class="relative w-full" data-carousel="slide">
        ...
        <div class="relative h-[300px] overflow-hidden rounded-lg">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="gambar/aset/pesawat-1.jpg"
                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="gambar/aset/pesawat-2.jpg"
                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
            <!-- Item 3 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="gambar/aset/pesawat-3.jpg"
                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
        </div>
        <!-- Slider indicators -->
...
<div class="max-w-screen-xl mx-auto p-4 flex justify-between">
    <div
        ...
        <div class="p-5">
            <a href="#">
                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Tiket Pesawat 1</h5>
            </a>
            ...
            <div class="flex items-center justify-between">
                <span class="text-3xl font-bold text-gray-900 dark:text-white">Rp 1.000.000,00</span>
                <a href="#"
